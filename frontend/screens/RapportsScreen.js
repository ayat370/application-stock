...
const styles = StyleSheet.create({
  ...
  typeBadge: { borderRadius: 14, paddingHorizontal: 14, paddingVertical: 8, backgroundColor: '#EEF2FF' },
  typeText: { fontWeight: '800', fontSize: 14, color: colors.primary },
  pdfBtn: { backgroundColor: colors.success, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, flexDirection: 'row', alignItems: 'center', gap: 8, shadowColor: '#0f172a', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.12, shadowRadius: 18, elevation: 6 },
  pdfText: { color: '#fff', fontSize: 13, fontWeight: '700' },
  ...
  bilanGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginTop: 14 },
  bilanItem: { backgroundColor: colors.card, borderRadius: 18, padding: 18, minWidth: '45%', flex: 1, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  bilanVal: { fontSize: 28, fontWeight: '800', color: colors.primary },
  bilanKey: { fontSize: 12, color: colors.textLight, fontWeight: '600', marginTop: 6 },
  inventaireResume: { fontSize: 13, color: colors.textLight, marginTop: 10, fontWeight: '500', backgroundColor: '#F8FAFC', padding: 12, borderRadius: 14 },
});
