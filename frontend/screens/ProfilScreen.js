...
const styles = StyleSheet.create({
  ...
  scrollContent: { alignItems: 'center', paddingBottom: 36, paddingTop: 16 },
  header: {
  ...
  contentWrapper: { width: '90%', maxWidth: 520, marginTop: 16 },
  ...
  userLogin: { fontSize: 14, color: 'rgba(255,255,255,0.72)', marginBottom: 10 },
  loadingText: { fontSize: 12, color: 'rgba(255,255,255,0.72)', marginTop: 6 },
  section: { marginBottom: 18 },
  sectionTitle: { fontSize: 16, fontWeight: '800', color: colors.text, marginBottom: 14 },
  permRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.border },
  permIcon: { fontSize: 16, marginRight: 12 },
  permLabel: { fontSize: 14, color: colors.text },
  logoutCard: { backgroundColor: '#FEF2F2', borderLeftWidth: 4, borderLeftColor: colors.danger, padding: 20, borderRadius: 18 },
