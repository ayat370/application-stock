...
const styles = StyleSheet.create({
  ...
  emplacementItem: {
    backgroundColor: colors.white, padding: 16, marginHorizontal: 16, marginVertical: 4,
    borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.05, shadowRadius: 4, elevation: 2,
  },
  emplacementName: { fontSize: 16, fontWeight: '600', color: colors.text },
  emplacementCode: { fontSize: 14, color: colors.textLight, marginTop: 4 },
});
