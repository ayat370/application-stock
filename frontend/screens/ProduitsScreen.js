...
const styles = StyleSheet.create({
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#EEF4FF', borderBottomWidth: 1, borderBottomColor: colors.border },
  headerCell: { paddingVertical: 16, paddingHorizontal: 14, borderRightWidth: 1, borderRightColor: colors.border, justifyContent: 'center' },
